...
class LocationTest extends BaseTestCase
{
    ...
    public function test_has_weather_returns_values(): void
    {
        ...
        $weather = new \Bejblade\OpenWeather\Entity\Weather($this->fixture('weather'), $this->fixture('weather')['timezone']);
    ...
    public function test_has_forecast_returns_values(): void
    {
        ...
        $forecast = new \Bejblade\OpenWeather\Entity\Forecast($this->fixture('forecast')['list'], $this->fixture('forecast')['city']['timezone']);
    ...
    public function test_forecast_returns_forecast(): void
    {
        ...
        $this->assertInstanceOf(\Bejblade\OpenWeather\Entity\Forecast::class, $this->location->forecast());
    }
    ...
    public function test_weather_returns_weather(): void
    {
        ...
        $this->assertInstanceOf(\Bejblade\OpenWeather\Entity\Weather::class, $this->location->weather());
    }
    ...
    public function test_has_air_pollution_returns_values(): void
    {
        ...
        $airPollution = new \Bejblade\OpenWeather\Entity\AirPollution($this->fixture('air_pollution'));
    ...
    public function test_air_pollution_returns_air_pollution(): void
    {
        ...
        $this->assertInstanceOf(\Bejblade\OpenWeather\Entity\AirPollution::class, $this->location->airPollution());
    }
